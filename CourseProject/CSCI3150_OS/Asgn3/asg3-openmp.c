...
void init(struct arg *);  // achieve initialization of hash table
void hashData(struct arg *);  // hash array1
void andData(struct arg *);   // AND array2, here we add the hash value by 1
void count(struct arg *);
void convert(struct arg *);
...
int main(int argc, char *argv[]) {
    ...
    for (i = 0; i < threadNum; i++)  // arguments initialization
    {
        args[i].index = i;
        args[i].hash = hash;
        args[i].buf = NULL;
